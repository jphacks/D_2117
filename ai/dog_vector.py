    ...
    def get_vector(self):
        ...
        if type(self.vector_out_dir) is str:
            ...
            for key in vec_dict.keys():                
                ...
                assert fname_extension in ['jpg', 'JPG'], f"Filename extension is {fname_extension}, but it must {['jpg', 'JPG']}"
                vector_npy_path = os.path.join(self.vector_out_dir, f"{vector_fname_extention[:-4]}.npy")
